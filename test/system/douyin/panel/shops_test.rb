...
class ShopsTest < ApplicationSystemTestCase
  setup do
    @douyin_panel_shop = douyin_panel_shops(:one)
  end

  test "visiting the index" do
    visit douyin_panel_shops_url
  ...
  test "should create shop" do
    ...
    fill_in "Name", with: @douyin_panel_shop.name
    fill_in "Poi", with: @douyin_panel_shop.poi_id
  ...
  test "should update Shop" do
    visit douyin_panel_shop_url(@douyin_panel_shop)
